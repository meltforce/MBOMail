...
> **Full disclosure:** This app was built entirely with [Claude Code](https://claude.com/product/claude-code) and has not been fully reviewed or verified by a human. I tested it myself and found it to be reliable and secure in my own usage. Use at your own discretion.
